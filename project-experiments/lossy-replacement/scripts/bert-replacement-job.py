...
def make_eval_fn(dataset, tokenizer, device, output_dir, eval_split="validation_matched"):
    def eval_fn(model):
...
def main(args):
    ...
    eval_fn = make_eval_fn(tokenized_dataset, tokenizer, device, trainer_output_dir)
    
    print("Evaluating pre-swap model...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="M-FAC/bert-tiny-finetuned-mnli")
