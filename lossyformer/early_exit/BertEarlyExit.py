...
class BertEarlyExit(nn.Module, EarlyExitBase):
    """Early exit wrapper for BERT with entropy-based layer-wise exit."""

    def __init__(self, original_model, threshold=0.3):
        """Initialize BertEarlyExit.

        Args:
            original_model: BERT model for sequence classification
        ...
        base_model = (
            original_model.bert if hasattr(original_model, "bert") else original_model
        )
        ...
        # Initialize mixin explicitly due to multiple inheritance
